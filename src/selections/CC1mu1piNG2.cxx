...
CC1mu1piNG2::CC1mu1piNG2() : SelectionBase("CC1mu1piNG2") {}

void CC1mu1piNG2::define_category_map() {
  categ_map_ = CC1mu1pi_MAP;
};

void CC1mu1piNG2::define_output_branches() {
...
void CC1mu1piNG2::compute_reco_observables(AnalysisEvent* Event) {
...
void CC1mu1piNG2::compute_true_observables(AnalysisEvent* Event) {
...
int  CC1mu1piNG2::categorize_event(AnalysisEvent* Event) {
...
bool CC1mu1piNG2::selection(AnalysisEvent* Event) {
...
bool CC1mu1piNG2::define_signal(AnalysisEvent* Event) {
